...
class RestaurantAdsView extends GetView<AdsServiceController> {
  const RestaurantAdsView({super.key});
  ...
  Widget build(BuildContext context) {
    return CarouselSlider(
      items: const [
        _Image(
          assetString: Assets
              .wedding_service_module$assets_images_restaurant_ads_image_1_jpeg,
        ),
        _Image(
          assetString: Assets
        ...
        _Image(
          assetString: Assets
              .wedding_service_module$assets_images_restaurant_ads_image_3_png,
        ),
        _Image(
          assetString: Assets
              .wedding_service_module$assets_images_restaurant_ads_image_4_jpeg,
        ),
      ],
