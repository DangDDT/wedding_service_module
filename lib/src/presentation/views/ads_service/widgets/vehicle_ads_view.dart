...
class VehicleAdsView extends GetView<AdsServiceController> {
  const VehicleAdsView({super.key});
  ...
  Widget build(BuildContext context) {
    return CarouselSlider(
      items: const [
        _Image(
          assetString:
              Assets.wedding_service_module$assets_images_car_ads_image_1_jpeg,
        ),
        _Image(
          assetString:
              Assets.wedding_service_module$assets_images_car_ads_image_2_jpeg,
        ),
        _Image(
          assetString:
              Assets.wedding_service_module$assets_images_car_ads_image_3_jpeg,
        ),
      ],
